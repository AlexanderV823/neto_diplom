...
// 20 февраля 2025 г.
    ...
    РеквизитыОбъекта = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Ссылка, "Дата, Контрагент, Договор");
    ...
    Запрос.УстановитьПараметр("ПериодНачало", НачалоМесяца(РеквизитыОбъекта.Дата));
    Запрос.УстановитьПараметр("ПериодКонец", КонецМесяца(РеквизитыОбъекта.Дата));
    Запрос.УстановитьПараметр("Клиент", РеквизитыОбъекта.Контрагент);
    Запрос.УстановитьПараметр("Договор", РеквизитыОбъекта.Договор);
