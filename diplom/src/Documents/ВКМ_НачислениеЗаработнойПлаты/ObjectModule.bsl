...
Процедура РассчитатьОклад() Экспорт
    ...
    Пока Выборка.Следующий() Цикл
        ...
        Движение.Результат = Движение.ПроцентПремии * Выборка.Факт / Выборка.План;               
...
Процедура РассчитатьОтпуск()
    ...
    Пока Выборка.Следующий() Цикл
        ...
        Движение.Результат = Выборка.РезультатБаза / Выборка.ЧасовОтработаноБаза * Движение.КалендарныеДни;
