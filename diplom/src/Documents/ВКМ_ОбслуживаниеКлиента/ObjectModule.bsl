...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
    ...
    Если Дата < ДанныеДоговора.ВКМ_НачалоДействияДоговора 
        Или Дата > ДанныеДоговора.ВКМ_ОкончаниеДействияДоговора 
        И ДанныеДоговора.ВидДоговора = ПредопределенноеЗначение("Перечисление.ВидыДоговоровКонтрагентов.ВКМ_АбоненскоеОбслуживание") Тогда
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
    ...
    ДополнительныеСвойства.Вставить("ДатаИзменена", Ложь);
    ДополнительныеСвойства.Вставить("ВремяРаботИзменено", Ложь);
    ДополнительныеСвойства.Вставить("СпециалистИзменен", Ложь);
    
    Если Не ЭтоНовый() Тогда
    
        //ДополнительныеСвойства.Вставить("ДокументИзменен", Ложь);
        //ДополнительныеСвойства.Вставить("ДатаИзменена", Ложь);
        //ДополнительныеСвойства.Вставить("ВремяРаботИзменено", Ложь);
        //ДополнительныеСвойства.Вставить("СпециалистИзменен", Ложь);
        ...
        Если ДанныеОбъекта.ДатаПроведенияРабот <> ДатаПроведенияРабот Тогда
            ...
            //ДополнительныеСвойства.Вставить("ДокументИзменен", Истина);
            ДополнительныеСвойства.Вставить("ДатаИзменена", Истина);
             
        КонецЕсли;
        
        Если ДанныеОбъекта.ВремяНачалаРабот <> ВремяНачалаРабот Тогда
        ...
        Если ДанныеОбъекта.Специалист <> Специалист Тогда
